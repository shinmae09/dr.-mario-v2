...
namespace DrMarioPlayer
{
    ...
    {
        public static ConcurrentDictionary<Pill, Tuple<Tile[,], Partner[,]>> LockPills(Tile[,] board, Partner[,] partner, List<Pill> pills)
        {
            ConcurrentDictionary<Pill, Tuple<Tile[,], Partner[,]>> gameBoards = new ConcurrentDictionary<Pill, Tuple<Tile[,], Partner[,]>>();
            ...
            Parallel.ForEach(pills, (pill) =>
            {
                ...
                gameBoards.TryAdd(pill, new Tuple<Tile[,], Partner[,]>(gameBoard, partnerBoard));
            });
